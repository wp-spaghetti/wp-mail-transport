...
2. Clone your fork: `git clone https://github.com/your-username/wp-mail-transport.git`
...
### Installation
```bash
git clone https://github.com/wp-spaghetti/wp-mail-transport.git
cd wp-mail-transport
composer install
```
